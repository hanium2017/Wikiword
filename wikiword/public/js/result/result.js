document.addEventListener('DOMContentLoaded', () => {
  ...
  getDataRendering({port: 12000, type: 'news',pageNum:1}, (item) => {
  ...
  getDataRendering({port: 12000, type: 'book',pageNum:1}, (item) => {
  ...
  getDataRendering({port: 13000, type:'youtube',pageNum:''}, (item) => {
  ...
  getDataRendering({port: 14000, type:'twitter'}, (item) => {
  ...
  getDataRendering({port: 16000, type:'dbpia',pageNum:1}, (item) => {
